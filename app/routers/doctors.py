...
@router.post("", response_model=DoctorResponse, status_code=status.HTTP_201_CREATED, summary="Admin: register a doctor")
...
@router.get("", response_model=list[DoctorResponse], summary="Admin: list registered doctors")
...
@router.get("/{doctor_id}", response_model=DoctorResponse, summary="Admin: retrieve a doctor")
...
@router.get(
    ...
    summary="Public: list a doctor's available slots",
)
